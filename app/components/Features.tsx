  ...
  const features = [
    {
      ...
      description:
        "Лев Логачев — блогер и знаток Китая, живет там несколько лет, снял 10+ фильмов и теперь лично ведёт вас в своё любимое место.",
    },
    {
      title: "Формат путешествия",
      description:
        "Авторский тур в минигруппе: без шаблонов, с редкими локациями, гибким ритмом и вниманием к каждому участнику.",
    },
    {
      title: "Для кого этот тур",
      description:
        "Для тех, кто ценит смысл в путешествиях, любит глубину, атмосферу и личный подход без суеты и толп.",
    },
    {
      title: "Что вас ждёт",
      description:
        "5 дней в Шанхае — контрасты, вкус, стиль и настоящая жизнь города. Не «как у всех», а как хочется именно вам",
    },
  ];
